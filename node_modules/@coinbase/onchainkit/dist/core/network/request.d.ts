 ...
 */
export declare function buildRequestHeaders(context?: RequestContext): Record<string, string>;
/**
 ...
 */
export declare function sendRequest<T, V>(method: string, params: T[], _context?: RequestContext): Promise<JSONRPCResult<V>>;
