...
import {
  HashMD,
  sha256
} from "./chunk-R3RTZXAG.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-RRV55GGF.js";
import {
  __export
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-HNYOK5SU.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-CMLSXAXH.js");
  const signature_ = (() => {
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = fromBytes(cursor.readBytes(Number.parseInt(size5), 32));
  return [value, 32];
}
...
function formatRequestCapabilities(capabilities) {
  const paymasterService = (capabilities == null ? void 0 : capabilities.paymasterService) ? Object.entries(capabilities.paymasterService).reduce((paymasterService2, [chainId, value]) => ({
    ...paymasterService2 ?? {},
...
//# sourceMappingURL=chunk-GBHARR65.js.map
