...
// node_modules/@coinbase/onchainkit/dist/version.js
function getVersion() {
  return "0.38.13";
}
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-H7TVQHBA.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-ANQAQCGH.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-NCOIZ35G.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-U6DYHGSV.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-BVJCE4SB.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-445UYIIM.js");
...
// node_modules/@coinbase/onchainkit/dist/core/network/constants.js
var POST_METHOD = "POST";
var JSON_HEADERS = {
  "Content-Type": "application/json",
  "OnchainKit-Version": version
};
var CONTEXT_HEADER = "OnchainKit-Context";
var JSON_RPC_VERSION = "2.0";
var RequestContext = ((RequestContext2) => {
...
// node_modules/@coinbase/onchainkit/dist/core/analytics/constants.js
var ANALYTICS_API_URL = "https://api.developer.coinbase.com/analytics";

// node_modules/@coinbase/onchainkit/dist/core/analytics/utils/sendAnalytics.js
...
// node_modules/@coinbase/onchainkit/dist/core/analytics/types.js
...
var WalletOption = ((WalletOption2) => {
...
var CheckoutEvent = ((CheckoutEvent2) => {
...
var TransactionEvent = ((TransactionEvent2) => {
...
var AppchainEvent = ((AppchainEvent2) => {
...
var ErrorEvent = ((ErrorEvent2) => {
  ErrorEvent2["ComponentError"] = "componentError";
  return ErrorEvent2;
})(ErrorEvent || {});

// node_modules/@coinbase/onchainkit/dist/core/constants.js
var Capabilities = ((Capabilities2) => {
...
//# sourceMappingURL=chunk-UT3QZF2C.js.map
