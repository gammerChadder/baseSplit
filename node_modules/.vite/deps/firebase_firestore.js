...
function fb(a, b2, c, d, e) {
  ...
  else (d = p(d) ? !!d.capture : !!d, c = $a(c), a && a[Ha]) ? (a = a.i, b2 = String(b2).toString(), b2 in a.g && (f = a.g[b2], c = Ta(f, c, d, e), -1 < c && (Ma(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b2], a.h--)))) : a && (a = bb(a)) && (b2 = a.g[b2.toString()], a = -1, b2 && (a = Ta(b2, c, d, e)), (c = -1 < a ? b2[a] : null) && gb(c));
}
function gb(a) {
...
function sc(a, b2) {
  ...
  if (0 != a.H) {
    ...
    else if (e = b2.s, 3 == e || 0 == e && 0 < b2.ca || !(1 == d && Id(a, b2) || 2 == d && Ac(a))) switch (c && 0 < c.length && (b2 = a.i, b2.i = b2.i.concat(c)), e) {
      case 1:
        J(a, 5);
        break;
      case 4:
...
var __PRIVATE_IndexBackfiller = class {
  ...
  ne(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r2 > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2)) return __PRIVATE_logDebug("IndexBackfiller", `Processing collection: ${t2}`), this.re(e, t2, r2).next((e2) => {
        r2 -= e2, n.add(t2);
      });
      i = false;
    })).next(() => t - r2);
...
var __PRIVATE_TargetIndexMatcher = class {
  ...
  tn(e) {
    ...
    for (; i < n.length && this.nn(n[i]); ++i) r2 = r2.add(n[i].fieldPath.canonicalString());
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  In(e, t, n, r2, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Tn(t[c / a]) : Te, l2 = this.En(e, _2, n[c % a], r2), h = this.dn(e, _2, i[c % a], s), P2 = o.map((t2) => this.En(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  Pn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r2) if (this.Vn(t, s.fieldPath) && isArray(e2)) r2 = this.mn(r2, s, e2);
      else {
  ...
  yn(e, t) {
    ...
    if (null != i) {
      ...
      if (isArray(s)) for (const i2 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Tn(i2), r2));
    } else n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, Te, r2));
    return n;
  }
  /**
  ...
  createRange(e, t, n) {
    ...
    for (let e2 = 0; e2 < r2.length; e2 += 2) {
      if (this.Dn(r2[e2], r2[e2 + 1])) return [];
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    for (const t2 of r2) this.wr = this.wr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  ...
  Jn(e, t) {
    return PersistencePromise.forEach(this.Zr, (n, r2) => this.er(e, n, r2).next((e2) => e2 ? PersistencePromise.resolve() : t(r2)));
  }
  removeTargets(e, t, n) {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    return r2.Fr(e, (r3) => this.er(e, r3, t).next((e2) => {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.D()) throw new FirestoreError(D2.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ei.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.kr ? this.kr.next() : __PRIVATE_ListenSequence._e), "readwrite-primary" === t ? this.gi(s).next((e2) => !!e2 || this.pi(s)).next((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.oi.enqueueRetryable(() => this.Ii(false)), new FirestoreError(D2.FAILED_PRECONDITION, v2);
      return n(s);
  ...
  ki(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Ci(e2.leaseTimestampMs, 5e3) && !this.Mi(e2.ownerId) && !this.Si(e2) && !(this.ai || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(D2.FAILED_PRECONDITION, de);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r2) {
    ...
    return this.ji(e, t).next((e2) => {
      ...
      if (!i.result) return this.Hi(e, t, r2, n).next((e2) => {
        i.result = e2;
      });
    }).next(() => {
      if (i.result) return;
      ...
      return this.Ji(e, t, n2).next((r3) => {
        if (i.result = r3, this.Ui) return this.Yi(e, t, n2, r3.size);
      });
    }).next(() => i.result);
  }
  Yi(e, t, n, r2) {
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r2.snapshotVersion.compareTo(s) >= 0) return i.$r.saveNamedQuery(e2, t);
  ...
  Fo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        } else __PRIVATE_logDebug(Ve, `RPC '${e}' stream ${r2} received:`, i2), P2.mo(i2);
      }
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  R_() {
    if (this.A_) throw new FirestoreError(D2.FAILED_PRECONDITION, "The client has already been terminated.");
  }
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, V_: o, parent: _ } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    const { ut: r3, parent: i2 } = __PRIVATE_toQueryTarget(e2, t2), s2 = {}, o2 = [];
    let _2 = 0;
...
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.F_) await t(
    /* enabled= */
    true
  );
}
async function __PRIVATE_disableNetworkInternal(e) {
  for (const t of e.F_) await t(
    /* enabled= */
    false
  );
}
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r2 of t2.targetIds)
          e2.C_.has(r2) && (await e2.remoteSyncer.rejectListen(r2, n2), e2.C_.delete(r2), e2.O_.removeTarget(r2));
      }(e, t);
    } catch (n2) {
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.N_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.N_.Zo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.x_.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await e.N_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.N_;
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.Q_) t3.z_(e2) && (r2 = true);
      i.q_ = e2;
    }
  }
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
  ...
  if (i) for (const e2 of i.Q_) e2.onError(n);
  r2.queries.delete(t);
}
...
var __PRIVATE_BundleLoader = class {
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ia.id), t = this.oa(this.documents);
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.Na = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1) return r2.Sa.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r2.wa.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r2 of e.Sa.get(t)) e.wa.delete(r2), n && e.ya.La(r2, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n) if (r2 instanceof __PRIVATE_AddedLimboDocument) e.va.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  ...
  if (r2 && r2.pa) return __PRIVATE_documentKeySet().add(r2.key);
  {
    let e2 = __PRIVATE_documentKeySet();
    const r3 = n.Sa.get(t);
    if (!r3) return e2;
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  ...
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Oa) {
    ...
    n.Oa = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    ...
    }(n), n.Oa = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const e3 of n2) {
        const t3 = r2.wa.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      }(e2.localStore, r3)) return await t2.close(), n2._completeWith(function __PRIVATE_bundleSuccessProgress(e3) {
        return {
          taskState: "Success",
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.ka.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.ka.syncEngine), await __PRIVATE_fillWritePipeline(this.ka.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    await this.persistence.fi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.ka.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
    const t = __PRIVATE_getWindow();
    if (!__PRIVATE_WebStorageSharedClientState.D(t)) throw new FirestoreError(D2.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  async za(e) {
    for (; this.buffer.length < e; ) {
      await this.Ha() && this.Ga("Reached the end of bundle when more is expected.");
    }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(D2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, i = await n.vo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r2, t2.length), s = /* @__PURE__ */ new Map();
      i.forEach((e3) => {
  ...
  async commit() {
    ...
    e.forEach((e2, t) => {
      ...
      await n.So("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r2);
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    ...
    n.Qa(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
...
var __PRIVATE_AsyncQueueImpl = class {
   ...
   */
  Eu(e) {
    for (const t of this.su) if (t.timerId === e) return true;
    return false;
  }
  /**
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && void 0 !== t.localCache) throw new FirestoreError(D2.INVALID_ARGUMENT, "cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new FirestoreError(D2.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
function enableIndexedDbPersistence(e, t) {
  ...
  if (n._uninitializedComponentsProvider) throw new FirestoreError(D2.FAILED_PRECONDITION, "SDK cache is already specified.");
...
function enableMultiTabIndexedDbPersistence(e) {
  ...
  if (t._uninitializedComponentsProvider) throw new FirestoreError(D2.FAILED_PRECONDITION, "SDK cache is already specified.");
...
function clearIndexedDbPersistence(e) {
  if (e._initialized && !e._terminated) throw new FirestoreError(D2.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
  const t = new __PRIVATE_Deferred();
...
function __PRIVATE_verifyNotInitialized(e) {
  if (e._initialized || e._terminated) throw new FirestoreError(D2.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  ...
  if (s.length % 2 != 0) throw new FirestoreError(D2.INVALID_ARGUMENT, `Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Vu)) throw t2.Su(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.Su(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n)) throw t2.Su(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
  if (t.search(we) >= 0) throw __PRIVATE_createError(
...
function __PRIVATE_validateQueryFilterConstraint(e, t) {
  if (!(t instanceof QueryFieldFilterConstraint || t instanceof QueryCompositeFilterConstraint)) throw new FirestoreError(D2.INVALID_ARGUMENT, `Function ${e}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e2), s2)), () => {
      i2.Qa(), e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e2), s2));
    };
...
var WriteBatch = class {
  ...
  _verifyNotCommitted() {
    if (this._committed) throw new FirestoreError(D2.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
  }
};
function __PRIVATE_validateReference(e, t) {
  if ((e = getModularInstance(e)).firestore !== t) throw new FirestoreError(D2.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
  return e;
}
...
function runTransaction(e, t, n) {
  ...
  const r2 = Object.assign(Object.assign({}, Se), n);
  !function __PRIVATE_validateTransactionOptions(e2) {
    if (e2.maxAttempts < 1) throw new FirestoreError(D2.INVALID_ARGUMENT, "Max attempts must be at least 1");
  }(r2);
...
function __PRIVATE_tryGetString(e, t) {
  if ("string" != typeof e[t]) throw new FirestoreError(D2.INVALID_ARGUMENT, "Missing string value for: " + t);
  return e[t];
}
...
function getPersistentCacheIndexManager(e) {
  ...
  if ("persistent" !== (null === (t = r2._uninitializedComponentsProvider) || void 0 === t ? void 0 : t._offlineKind)) return null;
  const i = new PersistentCacheIndexManager(r2);
  return be2.set(e, i), i;
}
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  constructor() {
    this.Mu = /* @__PURE__ */ new Map();
  }
  static get instance() {
    return De || (De = new ___PRIVATE_TestingHooksSpiImpl(), function __PRIVATE_setTestingHooksSpi(e) {
